...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1593178008,428577454}
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات سورس فاست \n※ مطور البوت @FPFFG","md",true, false, false, true, reply_markup)
return false 
end
---making user
if text and Redis:get(Fast..data.sender_id.user_id.."session") then
